...
{
    NSArray* array = @[@"Home",@"Person",@"More"];
...
{
    NSArray* normalName = @[@"icon1_c_footer@3x.png",@"icon2_c_footer.png",@"icon3_c_footer.png"];
    NSArray *selectedName = @[@"icon1_s_footer",@"icon2_s_footer",@"icon3_s_footer.png"];
    NSArray *tabBarName = @[@"首页",@"联系人",@"更多"];
    ...
    for (int i = 0; i < normalName.count; i++)
    {
        ...
        CGFloat left = (butWidth - 30)/2;
        
        [but setImageEdgeInsets:UIEdgeInsetsMake(4, left, TABBAR - 2 - 25, left)];
        UILabel * tabLabel = [[UILabel alloc]initWithFrame:CGRectMake(butWidth * i + left + 3.5, TABBAR - 25, butWidth - left, 23)];
        tabLabel.tag = 200 + i;
